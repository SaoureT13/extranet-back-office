                      ...
                      <div className="col-12">
                        <div className="card">
                          <div className="card-body p-0">
                            <div
                              className="alert alert-primary border-0 rounded-0 m-0 d-flex align-items-center"
                              role="alert"
                            >
                              <i
                              ...
                              <div>
                                <div className="avatar-sm flex-shrink-0">
                                  <span className="avatar-title bg-primary-subtle rounded-circle fs-2">
                                    <i data-feather="users" className="text-primary" />
                                  </span>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="card-body">
                            <div className="d-flex justify-content-between">
                              ...
                              <div>
                                <div className="avatar-sm flex-shrink-0">
                                  <span className="avatar-title bg-primary-subtle rounded-circle fs-2">
                                    <i data-feather="activity" className="text-primary" />
                                  </span>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="card-body">
                            <div className="d-flex justify-content-between">
                              ...
                              <div>
                                <div className="avatar-sm flex-shrink-0">
                                  <span className="avatar-title bg-primary-subtle rounded-circle fs-2">
                                    <i data-feather="clock" className="text-primary" />
                                  </span>
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="card-body p-0 pb-2">
                      <div>
                        <div
                          ...
                          data-colors='["--vz-primary", "--vz-light"]'
                          className="apex-charts"
                          dir="ltr"
                        />
                      </div>
                        ...
                        <table className="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                          <tbody className="border-0">
                            ...
                            <tr>
                              <td>
                                <h4 className="text-truncate fs-14 fs-medium mb-0">
                                  <i className="ri-stop-fill align-middle fs-18 text-success me-2" />
                                  Mobile Users
                                </h4>
                              </td>
                              <td>
                    ...
                    <div className="card-body">
                      ...
                      <div className="mt-3 pt-2">
                        ...
                        <div className="d-flex mb-2">
                          <div className="flex-grow-1">
                            <p className="text-truncate text-muted fs-14 mb-0">
                              <i className="mdi mdi-circle align-middle text-secondary me-2" />
                              www.youtube.com
                            </p>
                          </div>
                          <div className="flex-shrink-0">
