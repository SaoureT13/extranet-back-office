                    ...
                    <div className="px-lg-4">
                        <div className="tab-content">
                            <div
                                ...
                                role="tabpanel"
                                aria-pledby="v-pills-bill-info-tab"
                            >
                                <div>
                            ...
                            <div
                                ...
                                role="tabpanel"
                                aria-pledby="v-pills-bill-address-tab"
                            >
                                <div>
                            ...
                            <div
                                ...
                                id="v-pills-payment"
                                role="tabpanel"
                                aria-pledby="v-pills-payment-tab"
                            >
                                <div>
                            ...
                            <div
                                ...
                                id="v-pills-finish"
                                role="tabpanel"
                                aria-pledby="v-pills-finish-tab"
                            >
                                <div className="text-center pt-4 pb-2">
                                    <h5>Demande d'inscription du client:</h5>

                                    {currentData.str_socstatut === "process" ? (
                                        <div className="col-12 d-flex justify-content-between align-items-center mt-4">
                                            <button
                                                ...
                                                type="button"
                                                class="btn btn-danger btn-lg waves-effect waves-light"
                                            >
                                                Refuser
                                            </button>
                                            <button
